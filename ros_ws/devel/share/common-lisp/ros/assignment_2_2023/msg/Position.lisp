...
(cl:defmethod cl:initialize-instance :after ((m <Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment_2_2023-msg:<Position> is deprecated: use assignment_2_2023-msg:Position instead.")))
...
(cl:defmethod vel_x-val ((m <Position>))
